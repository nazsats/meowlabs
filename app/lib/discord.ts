...
const ROLE_PROPERTIES: Record<string, { type: 'GTD' | 'FCFS'; mintPhase: string }> = {
  ...
  'Claw Collector': { type: 'GTD', mintPhase: 'Phase 2' },
  'Active Paw': { type: 'GTD', mintPhase: 'Phase 2' },
  'Monad Veteran': { type: 'GTD', mintPhase: 'Phase 2' },
  'Early Kitten': { type: 'GTD', mintPhase: 'Phase 2' },
  'Pawthfinder': { type: 'GTD', mintPhase: 'Phase 3' },
  'Yarn Master': { type: 'GTD', mintPhase: 'Phase 3' },
  'Alley Alpha': { type: 'GTD', mintPhase: 'Phase 3' },
  'Shadow Stalker': { type: 'GTD', mintPhase: 'Phase 3' },
  'Furion Elite': { type: 'GTD', mintPhase: 'Phase 4' },
  'Mythic Pouncer': { type: 'GTD', mintPhase: 'Phase 4' },
  'Catcents Legend': { type: 'GTD', mintPhase: 'Phase 4' },
  'Catlist': { type: 'FCFS', mintPhase: 'Phase 5' },
  'Test Catlist Role': { type: 'FCFS', mintPhase: 'Phase 5' },
  'Game Champion': { type: 'FCFS', mintPhase: 'Phase 5' },
  'Whisker Initiate': { type: 'FCFS', mintPhase: 'Phase 5' },
};
